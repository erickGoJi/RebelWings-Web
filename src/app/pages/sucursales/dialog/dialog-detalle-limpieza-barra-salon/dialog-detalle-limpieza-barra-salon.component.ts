...
@Component({
  selector: 'app-dialog-detalle-limpieza-barra-salon',
  templateUrl: './dialog-detalle-limpieza-barra-salon.component.html',
  styleUrls: ['./dialog-detalle-limpieza-barra-salon.component.css']
})
export class DialogDetalleLimpiezaBarraSalonComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<DialogDetalleLimpiezaBarraSalonComponent>,
