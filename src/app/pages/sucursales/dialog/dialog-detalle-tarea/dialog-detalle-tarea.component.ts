...
@Component({
  selector: 'app-dialog-detalle-tarea',
  templateUrl: './dialog-detalle-tarea.component.html',
  styleUrls: ['./dialog-detalle-tarea.component.css']
})
export class DialogDetalleTareaComponent implements OnInit {
  public user;
  public data;
  public taskId;
