...
@Component({
  selector: 'app-dialog-detalle-conteo-personas',
  templateUrl: './dialog-detalle-conteo-personas.component.html',
  styleUrls: ['./dialog-detalle-conteo-personas.component.css']
})
export class DialogDetalleConteoPersonasComponent implements OnInit {
