...
@Component({
  selector: 'app-dialog-detalle-mesa-espera',
  templateUrl: './dialog-detalle-mesa-espera.component.html',
  styleUrls: ['./dialog-detalle-mesa-espera.component.css']
})
export class DialogDetalleMesaEsperaComponent implements OnInit {
  public user;
  public data;
  public taskId;
  ...
  constructor(public dialogRef: MatDialogRef<DialogDetalleMesaEsperaComponent>,
