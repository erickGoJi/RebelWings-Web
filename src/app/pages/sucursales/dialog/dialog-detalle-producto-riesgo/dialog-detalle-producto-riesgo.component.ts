...
@Component({
  selector: 'app-dialog-detalle-producto-riesgo',
  templateUrl: './dialog-detalle-producto-riesgo.component.html',
  styleUrls: ['./dialog-detalle-producto-riesgo.component.css']
})
export class DialogDetalleProductoRiesgoComponent implements OnInit {
