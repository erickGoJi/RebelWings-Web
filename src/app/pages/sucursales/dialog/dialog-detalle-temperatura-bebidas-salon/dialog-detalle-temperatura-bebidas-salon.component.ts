...
@Component({
  selector: 'app-dialog-detalle-temperatura-bebidas-salon',
  templateUrl: './dialog-detalle-temperatura-bebidas-salon.component.html',
  styleUrls: ['./dialog-detalle-temperatura-bebidas-salon.component.css']
})
export class DialogDetalleTemperaturaBebidasSalonComponent implements OnInit {
  public user;
  public data;
  public taskId;
  ...
  constructor(public dialogRef: MatDialogRef<DialogDetalleTemperaturaBebidasSalonComponent>,
