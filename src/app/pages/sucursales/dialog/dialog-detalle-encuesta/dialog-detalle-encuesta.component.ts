...
@Component({
  ...
  templateUrl: './dialog-detalle-encuesta.component.html',
  styleUrls: ['./dialog-detalle-encuesta.component.css']
})
export class DialogDetalleEncuestaComponent implements OnInit {
  public user;
  public data;
  public taskId;
